...
import { TrendingDown, TrendingUp, TrendingUpDown, Wallet } from 'lucide-react';
...
function StatCard({formatter, value, title, icon}: {formatter: Intl.NumberFormat, value: number, title: string, icon: React.ReactNode}) {
